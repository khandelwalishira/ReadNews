...
public class SportsFragment extends Fragment {
    ...
    Adapter adapter;
    String country="in";
    private RecyclerView sportsecyclerview;
    private String category="sports";

    @Override
    public View onCreateView(@NonNull  LayoutInflater inflater, @Nullable ViewGroup container, @Nullable  Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.sportfragement, null);
        sportsecyclerview=v.findViewById(R.id.sportsrecyclerview);
        modelclassArrayList=new ArrayList<>();
        sportsecyclerview.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getContext(),modelclassArrayList);
        sportsecyclerview.setAdapter(adapter);
        findNews();
        return v;
    }
